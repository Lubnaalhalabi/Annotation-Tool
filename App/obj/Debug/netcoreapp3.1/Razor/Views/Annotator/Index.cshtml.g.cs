#pragma checksum "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1883552c88d39e50ad693040d3e1a876338de9f3"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Views_Annotator_Index), @"mvc.1.0.view", @"/Views/Annotator/Index.cshtml")]
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1883552c88d39e50ad693040d3e1a876338de9f3", @"/Views/Annotator/Index.cshtml")]
    ...
    public class Views_Annotator_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<App.ViewModels.AdminRegisterViewModel>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#nullable restore
#line 2 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
  
    ViewData["Title"] = "Annotator";
...
#nullable disable
            ...
            DefineSection("CSS", async() => {
                WriteLiteral("\r\n    <link rel=\"stylesheet\" href=\"/css/Annotator.css?v3\" />\r\n");
            }
            );
            DefineSection("annotators_link", async() => {
                WriteLiteral("\r\n    my_navlink-active\r\n");
            }
            );
        ...
        <div class=""card mb-4"">
            <div class=""card-header pb-0 p-3"" style=""z-index: 1"">
                ...
                <div class=""col-xl-4 my-navpart"">
                    <h6 class=""mb-2 header"">Annotators</h6>
                </div>
...
");
            ...
            <div class=""card-body my-card"">
                <div class=""row"" id=""annotatorBody"">
                </div>
            </div>
        </div>
    </div>
    ...
    function managerCardViewFilpper(id, type) {
        if (type == 1) {
            ...
            $(""#Tasks-"" + id).attr(""style"", ""display: block"");
                ...
                WriteLiteral("\n\r\n        function loadData() {\r\n            var id = 1;\r\n            var image;\r\n            $.ajax({\r\n                url: \'");
#nullable restore
#line 128 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                 Write(Url.Action("GetAll", "Annotator"));
...
#nullable disable
                ...
                WriteLiteral(@"                      ${item.email}
                                                    ...
                                                    <div class=""d-flex align-items-center justify-content-between"">
                                                        <button onclick=""ViewTasks('${item.id}',${id})"" type=""button"" class=""btn bg-gradient-primary mt-3 w-90 tasks"">View tasks</button>
                                                    </div>
                                                </div>
                                            </div>
                                   ");
...
#nullable restore
#line 176 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                                                                       Write(Url.Action("Edit", "Annotator"));
                                ...
                                <div class=""flip-card-inner"" id=""flipper-create"">
                                    ...
                                    <div class=""flip-card-front"" style="" margin-top: 75px;"" onclick=""$('#flipper-create').attr('style','transform: rotateY(180deg);')"">
                                        <div class=""card h-100 card-plain"">
                                            <div class=""car");
                WriteLiteral(@"d-body d-flex flex-column justify-content-center text-center"">
                                                <a href=""javascript:;"">
                                    ...
                                    <div class=""flip-card-back"" style="" margin-top: -9px;"">
                                        <div class=""card h-100 card-plain"">
                                            <div class=""card-body d-flex flex-column justify-content-center text-center"">
                                                <i class=""fas fa-times p-3 cursor-pointer text-secondary opacity-8 position-absolute end-3 top-3"" style="" margin-top: 30px; margin-r");
                WriteLiteral(@"ight: 25px;"" onclick=""$('#flipper-create').attr('style','')""></i>
                                                <div class=""position-relative img-cont"">
                                                  <img alt=""Image placeholder "" class=""user_img"" src=""/img/create.jpg"">
                                                </div>
                                                <form method=""POST"" action=""");
#nullable restore
#line 239 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                                                                       Write(Url.Action("Create","Annotator"));
    ...
    <script>
        function ViewTasks(itemId, id) {
            ...
            $.ajax({
                url: '");
#nullable restore
#line 271 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                 Write(Url.Action("ViewTasks", "Annotator"));
...
#nullable disable
    ...
    ");
            ...
            $.ajax({
                url: '");
#nullable restore
#line 305 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                 Write(Url.Action("Delete","Annotator"));
...
#nullable disable
    ...
    <script>
        ...
        var numberOfPages = ");
#nullable restore
#line 319 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
        ...
        $(document).ready(function () {
            $(document).on('click', '#search', function (e) {
                ...
                $.ajax({
                    url: '");
#nullable restore
#line 442 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
                     Write(Url.Action("Search", "Annotator"));
...
#nullable disable
                                        ...
                                        <div class=""flip-card-inner"" id=""flipper-${id}"">
                                            <div class=""flip-card-front"">
                                                <div class=""my-front"">
                                                    ...
                                                    <i onclick=""$('#flipper-${id}').attr('style','transform: rotateY(180deg);');managerCardViewFilpper('${item.id}',1)"" class=""fa fa-pen  p-3 cursor-pointer text-secondary opacity-8 position-absolute end-10 top-0""></i>
                                               ");
                WriteLiteral(@"     <div class=""position-relative img-cont"">
                                                        <img src=""/img/users/${image}"" alt=""profile_image"" class=""w-100 border-radius-lg shadow-sm"">
                                                    </div>
                                                    <div class=""card-body px-1 pb-0 info"">
                                                        <h5 style=""color:black"">
             ...
             ");
                WriteLiteral(@"                                           <p class=""mb-4 text-sm"">
                                            ...
                                            <div class=""flip-card-back"">
                                                <div id=""Edit-${item.id}"" >
                                                    <i class=""fas fa-times p-3 cursor-pointer text-secondary opacity-8 po");
                WriteLiteral(@"sition-absolute end-1 top-0"" onclick=""$('#flipper-${id}').attr('style','')""></i>
                                                    <div class=""position-relative img-cont"">
                                                        <img src=""/img/users/${image}"" alt=""profile_image"" class=""w-100 border-radius-lg shadow-sm"">
                                                    </div>
                                                    <form method=""POST"" action=""");
#nullable restore
#line 502 "C:\Users\ASUS\Desktop\Annotation\App\Views\Annotator\Index.cshtml"
